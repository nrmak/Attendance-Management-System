...
<div class="card " style="background-color:#ffffff;" >
   ...
   <b>Details</b>
	...
	<br/><br/>
	<div class="card-body">
 		<form method="post" action="update_attendence.jsp">
 		 <div class="form-group">
 		<p>Please Select the Following Details</p>
...
<div class="form-group">
      <label> Semester</label> <select class="form-control" id="exampleFormControlSelect1" name="semester">  <option>1</option>
       						  ...
       						  <option>8</option>
       						   ...
       						   <div class="form-group">
        <label>Total Number of Classes Taken</label> <input type="number"  min="1" max="2" name="cls" class="form-control" value=1 >
