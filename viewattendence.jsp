...
try {
   ...
   out.println("<thead>");
    ...
    rs=stmt.executeQuery("select * from attendence where sid='" + sid[i] + "'");
	   if(rs.next())
	   {
		   out.println("<td>"+Math.round(Double.parseDouble(rs.getString("sub1"))* 100.0) / 100.0+"</td>");
		    out.println("<td>"+Math.round(Double.parseDouble(rs.getString("sub2"))* 100.0) / 100.0+"</td>");
		    out.println("<td>"+Math.round(Double.parseDouble(rs.getString("sub3"))* 100.0) / 100.0+"</td>");
		    out.println("<td>"+Math.round(Double.parseDouble(rs.getString("sub4"))* 100.0) / 100.0+"</td>");
		    out.println("<td>"+Math.round(Double.parseDouble(rs.getString("sub5"))* 100.0) / 100.0+"</td>");
		    if(sub6.equals("N/A"))
		    {
		    	System.out.println(" if k andar");
		    	total=Double.parseDouble(rs.getString("sub1"))+Double.parseDouble(rs.getString("sub2"))+
		    	Double.parseDouble(rs.getString("sub3"))+Double.parseDouble(rs.getString("sub4"))+
		    	Double.parseDouble(rs.getString("sub5"));
		    	total/=5;
		    ...
		    else
		    {
		    	total=Double.parseDouble(rs.getString("sub1"))+Double.parseDouble(rs.getString("sub2"))+
				    	Double.parseDouble(rs.getString("sub3"))+Double.parseDouble(rs.getString("sub4"))+
				    	Double.parseDouble(rs.getString("sub5"))+Double.parseDouble(rs.getString("sub6"));
		    	total/=6;
		    	out.println("<td>"+Math.round(Double.parseDouble(rs.getString("sub2"))* 100.0) / 100.0+"</td>");
		    	out.println("<td>"+Math.round(total * 100.0) / 100.0+"</td>");
		    }
